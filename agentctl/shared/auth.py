"""Authentication module for Claude Code agents.
...
@dataclass
class AuthConfig:
    """Authentication configuration for agent launches.

    Specifies which authentication method to use and the corresponding
    secret names in GCP Secret Manager.
    """

    auth_type: AuthType = AuthType.API_KEY
    api_key_secret_name: str = "anthropic-api-key"
    oauth_credentials_secret_name: str = "claude-oauth-credentials"
